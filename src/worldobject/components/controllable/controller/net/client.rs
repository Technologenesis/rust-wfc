...
use crate::worldobject::{
    human,
    components::controllable::ControllableTrait
};
...
impl NetworkHumanControllerClient {
    ...
    async fn handle_message(message: NetworkHumanControllerMessage, subcontroller: &mut Controller, tcp_stream: &mut TcpStream) -> Result<(), Box<dyn std::error::Error>> {
        match message {
